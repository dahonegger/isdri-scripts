function [ ] = fetchWavesNDBC(buoyNum,saveDir,fname)
%fetchWavesNDBC downloads a .txt file of met data from NDBC webpage
...
url = ['http://www.ndbc.noaa.gov/data/realtime2/',num2str(buoyNum),'.spec']; 
