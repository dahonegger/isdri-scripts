...
saveDir = 'D:\guadalupe\postprocessed\phase_resolved_pngs\'; % HUB
...
for iDay = 1:numel(dayFolder)
    ...
    if ~exist(saveDirSub);mkdir(saveDirSub);end
        ...
        for iRun = 1:20:length(dayFolder(iDay).polRun)
            ...
            pngBaseName = sprintf('%s_phase_resolved.png',cubeBaseName);
