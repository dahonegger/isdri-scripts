...
%% Add path
addpath(genpath('/nfs/depot/cce_u1/shared/odea/GitHub/isdri-scripts'));
addpath(genpath('/nfs/depot/cce_u1/shared/odea/GitHub/cBathy-Toolbox-master'));

%% define time of interest
startTime = '20170908_1630';
endTime = '20170908_2355';

baseDir = ['/nfs/attic/hallerm2/isdri/guadalupe/processed/'];
saveFolder = ['/nfs/attic/hallerm2/isdri/guadalupe/postprocessed/ripVideos/' startTime '-' endTime];
mkdir(saveFolder)
...
rot = -13;
bave = 3;
[dnUTC_AQ,Ubave,Vbave,Wbave,ZBed,depth] = loadADCP('/nfs/depot/cce_u1/haller/shared/odea/ISDRI/SupportData/MacMahan/STR3_AQ.mat', bave, rot);

A = load('/nfs/depot/cce_u1/haller/shared/odea/ISDRI/SupportData/MacMahan/ptsal_tchain_STR3_A');  % Most offshore
B = load('/nfs/depot/cce_u1/haller/shared/odea/ISDRI/SupportData/MacMahan/ptsal_tchain_STR3_B');  % Middle, with ADCP
C = load('/nfs/depot/cce_u1/haller/shared/odea/ISDRI/SupportData/MacMahan/ptsal_tchain_STR3_C');  % Most onshore
E = load('/nfs/depot/cce_u1/haller/shared/odea/ISDRI/SupportData/MacMahan/ptsal_tchain_STR3_E');  % to south
load('/nfs/depot/cce_u1/haller/shared/odea/ISDRI/cMap.mat')
