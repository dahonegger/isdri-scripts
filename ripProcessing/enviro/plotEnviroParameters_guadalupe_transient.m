...
% % from spoondrift
load('D:\Data\ISDRI\SupportData\Spoondrift\SPOT-0020');
t_ISDRI = time;
...
axis([datenum([2017,9,7,0,0,0]) datenum([2017,10,26,0,0,0]) 0 4])
datetick('x','keeplimits')
ylabel('Hs (m)')
title('Significant wave height from SPOT-0020');
...
datetick('x')
ylabel('Tp (s)')
title('Wave period from SPOT-0020');
...
% hold on
% plot(dn,(meanDir_dnrips_Guadalupe-270),'r','Linewidth',1.5);
% % plot(dn,(meanDirSpr_dnrips_Guadalupe),'r','Linewidth',1.5);
% xlabel('Time'); ylabel('MWD (degrees)')
% title('Mean wave direction from shore normal, from SPOT-0020');
...
subplot(3,1,2)
plot(t_ISDRI,(meanDir-270-13),'b');
hold on
plot(dn,(meanDir_dnrips_Guadalupe-270-13),'r','Linewidth',1.5);
 ylabel('\thetam (\circ)')
title('Mean wave direction from shore normal, from SPOT-0020');
axis([datenum([2017,9,7,0,0,0]) datenum([2017,10,26,0,0,0]) -40 40])
datetick('x','keeplimits')
...
axis([datenum([2017,9,7,0,0,0]) datenum([2017,10,26,0,0,0]) 0 60])
datetick('x','keeplimits')
title('Mean directional spread, from SPOT-0020')
xlabel('Time');
