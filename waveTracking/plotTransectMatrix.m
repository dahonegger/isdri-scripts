...
baseDir = 'C:\Users\user\Desktop\waveTracking\';
fname = 'rangeTransects_lat_lon.mat';

load(fullfile(baseDir,fname))
load('clickpoints.mat');

times = txDn_full(380:923) - 7/24;

[plotDN,plotRG] = meshgrid(times,Rg);
[plotDN_lon, PlotLon] = meshgrid(times,-1.*txLat_full);

fig3=figure;
hold on
pcolor(plotRG,plotDN,transectMat(:,380:923))
shading flat
% colormap hot
